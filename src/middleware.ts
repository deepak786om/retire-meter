 ...
 * here takes down the entire site — including marketing pages, which have no business
 * depending on Supabase. Misconfiguration should degrade to "logged out", never a 500.
 */
